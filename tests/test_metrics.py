...
import sys
from pathlib import Path
from src.metrics import rv_coefficient, Rejection, TrueRejection, FalseRejection, RelativeFrobeniusNorm
...
class TestRelativeFrobeniusNorm:
    ...
    def test_tuple_input_multiple_networks(self):
        ...
        # Network 1
        t1 = np.array([[1., 0.], [0., 1.]])
        e1 = np.array([[1., 0.], [0., 1.]]) # Perfect match
        
        # Network 2
        t2 = np.array([[2.]])
        e2 = np.array([[4.]]) # Double the value
        
        results = {
            "estimated_latent": (e1, e2),
            "true_latent": (t1, t2)
        }
